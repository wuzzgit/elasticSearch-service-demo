...
import com.elasticsearch.service.entity.EsPage;
import com.elasticsearch.service.util.ElasticsearchUtil;
...
//    }
    ...
    public String getData(String id){
        if(StringUtils.isNotBlank(id)) {
            ...
            return JSONObject.toJSONString(matchAll);
        }
    }
